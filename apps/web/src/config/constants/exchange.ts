...
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD, WBTC_ETH,songbirdTokens } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.SONGBIRD]: '0x1CF1AFbD46A9bB1e584Da39A9205193169A7A2c7',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.SONGBIRD]: [songbirdTokens.busd, songbirdTokens.cake, songbirdTokens.wbnb],
